<div class="p-10">
    ...
    <div class="w-full flex py-10 px-5 gap-5 border rounded-lg bg-gray-50">
        <div class="w-[50%] flex flex-col gap-3 text-gray-600">
            <dt>Controle a turbidez da água e confira o comportamento do sensor</dt>
        ...
        <div class="w-[50%] flex justify-center items-center gap-8">
            <div class=" flex flex-col items-center justify-center">
                <dt class="mb-2 text-5xl font-extrabold">73%</dt>
                <dd class="text-gray-600 dark:text-gray-600">Turbidez</dd>
            </div>
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-5xl font-extrabold">73Ω</dt>
                <dd class="text-gray-600 dark:text-gray-600">Tensão</dd>
            </div>
        </div>
    </div>
</div>
